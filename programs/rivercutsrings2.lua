...
function runTile(dx, dy)
	...
	local off = 0.125*math.sin(0.05*dd)+0.1
	local off2 = 4*math.max(0, math.sin(0.11*dd)-0.9)
	local off3 = 4*math.max(0, math.sin(0.11*dd)-0.8)
	
	local eval = math.abs(val)-off-off2
	local eval2 = math.abs(val2)+off+off3
